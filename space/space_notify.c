...
*/
	char *dbref;
dbref=unparse_dbref(sdb[x].object);
...
*/
	...
	//sprintf(shiplifesupport,"#%i",unparse_integer(sdb[x].object));				
	


	//notify(theplayer,tprintf("%s DBREF",unparse_dbref(sdb[x].object)));

	do_zemit(5,dbref,msg);
...
/* ------------------------------------------------------------------------ */
//This function lets the other ships in the neigherhood know!
