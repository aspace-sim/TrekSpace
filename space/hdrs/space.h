...
#endif /* PI */
#define getrandom(x) get_random_long(0,x-1)
...
#define MAX_EMPIRE_NAME           11
/* Edited System_name by bill to add life support - Bill*/
#define MAX_SYSTEM_NAME           16
#define MAX_QUADRANT_NAME         4
#define MAX_TYPE_NAME             11
#define MAX_BEAM_NAME             70
#define MAX_MISSILE_NAME          40

#define MIN_SPACE_OBJECTS         1
#define MAX_SPACE_OBJECTS         500

#define MIN_CONSOLE_COUNT         1
#define MAX_CONSOLE_COUNT         100

#define MAX_DOCKING_DISTANCE      5.0
#define MAX_LANDING_DISTANCE      5.0
...
//LEts define some custom new Variables
#define SELF_DESTRUCT_RANGE		  46284894  //The is .015 PC
//#define COLLISION_RANGE			    441623   //This is .001 PC
#define COLLISION_RANGE			    1   //This is .001 PC
//END NEW VARIABLES
...
//This defines the warp core parent
#define WARP_CORE_PARENT	1683

//Lets define the empire space parents
//these objects will hold the setting sfor each empire
//Frequenices IFF settings etc
#define FEDERATIONEMPIRE	4035
#define ROMULANEMPIRE		4034
#define KLINGONEMPIRE		4032
...
#define MAX_BEAM_BANKS            40
#define DEF_BEAM_REFRESH 	  10

#define MISSILE_ATTR_NAME         "MISSILE"
#define MISSILE_DATA_NUMBER       6
...
#define MAX_MISSILE_TUBES         40
#define DEF_MISSILE_REFRESH       10


#define ENGINE_ATTR_NAME          "ENGINE"
#define ENGINE_DATA_NUMBER        10
...
#define CLOAK_DATA_NUMBER         7

#define TRANS_ATTR_NAME           "TRANS"
#define TRANS_DATA_NUMBER         8

//**************START CUSTOM EDITS*********
/* Added by bill 4-9-2002 */
#define LIFESUPPORT_ATTR_NAME           "LIFESUPPORT"
#define LIFESUPPORT_DATA_NUMBER        4

#define CF_ATTR_NAME           "CF"
#define CF_DATA_NUMBER        1

#define BREAKDOWN_ATTR_NAME           "BREAKDOWN"
#define BREAKDOWN_DATA_NUMBER        1
...
#define MAIN_DATA_NUMBER          6

#define AUX_ATTR_NAME             "AUX"
#define AUX_DATA_NUMBER           6

#define BATT_ATTR_NAME            "BATT"
#define BATT_DATA_NUMBER          6
...
//****************START CUSTOM EDIETS*************
     struct lifesupport_t        lifesupport;	 
     struct cf_t        cf;	 
     struct breakdown_t        breakdown;	 
	 struct iff_t        iff;
//****************END CUSTOM EDIETS*************
...
extern int beam_refresh;
extern int missile_refresh;
...
extern char *format_s_Life_Support (int x);
