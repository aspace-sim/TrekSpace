...
char *ansi_alert (const char *msg)
{
	...
	snprintf(buffer, sizeof(buffer), "%s%s[%s%s%s%s]%s",
	  ANSI_HILITE,ANSI_BLUE, ANSI_CYAN, msg, ANSI_HILITE,ANSI_BLUE, ANSI_WHITE);
...
char *ansi_cmd (dbref enactor, const char *msg)
{
	...
	snprintf(buffer, sizeof(buffer), "%s%s[%s%s%s%s%s]--[%s%s%s]%s",
	  ANSI_HILITE,ANSI_BLUE, ANSI_YELLOW, ANSI_HILITE, Name(enactor), ANSI_NORMAL,
...
char *ansi_warn (const char *msg)
{
	...
	snprintf(buffer, sizeof(buffer), "%s%s[%s%sWARNING%s%s]--[%s%s%s]%s",
	  ANSI_HILITE,ANSI_BLUE, ANSI_RED, ANSI_BLINK, ANSI_NORMAL, ANSI_BLUE, ANSI_CYAN,
